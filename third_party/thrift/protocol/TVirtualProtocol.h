...
using lbug_apache::thrift::transport::TTransport;
...
public:
  ...
  uint32_t skip(TType type) { return ::lbug_apache::thrift::protocol::skip(*this, type); }
...
public:
  ...
  uint32_t skip(TType type) {
    ...
    return ::lbug_apache::thrift::protocol::skip(*prot, type);
  }
