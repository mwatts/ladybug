...
const KUZU_WASM_INDEX_PATH = path.join(__dirname, "node_modules", "lbug-wasm", "index.js");
const KUZU_WASM_WORKER_PATH = path.join(__dirname, "node_modules", "lbug-wasm", "lbug_wasm_worker.js");
...
fs.copyFileSync(KUZU_WASM_WORKER_PATH, path.join(DESTINATION_PATH, "lbug_wasm_worker.js"));
console.log("Done.");
